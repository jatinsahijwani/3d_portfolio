  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_8b49ek1',
      {
        ...
        to_email: 'jatinsahijwani2151@gmail.com',
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex-[0.75] bg-black-100 p-8 rounded-2xl max-w-s"
      >
        <p className={`${styles.sectionSubText}`}>Get in touch.</p>
        <h3 className={`text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]`}>Communicate.</h3>
        <form
          ref={formRef}
        ...
        >
          ...
          <button type="submit" className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl hover:bg-secondary hover:text-black-100">
      ...
      <motion.div
        ...
        className="xl:flex-1 xl:h-auto md:h-[550px] min-w-[50%] h-[350px]"
      >
        <EarthCanvas/>
      </motion.div>
    </div>
